  ...
  return (
    <>
      ...
      <div>
        ...
        <br/>
          <img src={GirlDancing} alt="Girl Dancing at NYC wedding" width='100%' style={{borderRadius: "10px"}}/>
        <br/>
        <br/>
          <img src={OldGuy} alt="Guy dancing at NYC wedding" width='100%' style={{borderRadius: "10px"}}/>
        <br/>
        <br/>
